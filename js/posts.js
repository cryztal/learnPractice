   ...
   likes: ['author', 'someone', 'else']
    ...
    function validatePostCreatedAt(post) {
      if (typeof post.createdAt !== 'object') {
        //console.log("Invalid field createdAt!");
        return false;
      }
      return true;
    }
    function validateDescription(post){
      if (typeof post.description !== 'string') {
        //console.log("Invalid field description!");
        return false;
      }
      return true;
    }
    ...
    function validateLikes(post){
      if (typeof post.likes !== 'object') {
        //console.log("Invalid field likes!");
        return false;
      }
      return true;
    }
